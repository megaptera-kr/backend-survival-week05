...
public class PostController {
  ...
  @PatchMapping("/{id}")
  public PostResponseDto update(@PathVariable String id,
  ...
  @DeleteMapping("/{id}")
  public PostResponseDto delete(@PathVariable String id) {
    PostResponseDto postDto = deletePostService.deletePost(id);
