...
import static kr.megaptera.assignment.utils.AppStringUtils.PATH_SEPERATOR;
import static kr.megaptera.assignment.utils.AppStringUtils.POST_REQ_MAP;
  ...
  void update() throws Exception {
    ...
    this.mockMvc.perform(
          patch(POST_REQ_MAP + PATH_SEPERATOR + targetPostResponseDto.getId()).contentType(
                ...
                .andExpect(jsonPath("$.title", equalTo(title)))
                .andExpect(jsonPath("$.content", equalTo(content)))
                .andExpect(jsonPath("$.id", equalTo(targetPostResponseDto.getId())))
                .andExpect(jsonPath("$.author", equalTo(targetPostResponseDto.getAuthor())));
  }
  ...
  void deletePost() throws Exception {
    ...
    this.mockMvc.perform(
          patch(POST_REQ_MAP + PATH_SEPERATOR + targetPostResponseDto.getId()))
                ...
                .andExpect(jsonPath("$.content", equalTo(targetPostResponseDto.getContent())))
                .andExpect(jsonPath("$.id", equalTo(targetPostResponseDto.getId())))
                .andExpect(jsonPath("$.author", equalTo(targetPostResponseDto.getAuthor())));
  }
}
