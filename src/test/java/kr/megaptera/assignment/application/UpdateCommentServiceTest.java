...
class UpdateCommentServiceTest {
    ...
    void update() {
        ...
        Comment comment = new Comment(commentId, postId, "작성자", new MultilineText("내용"));

        given(commentRepository.find(commentId, postId)).willReturn(comment);

        CommentUpdateDto commentUpdatedDto = new CommentUpdateDto("변경된 내용");
        ...
        assertThat(comment.content()).isEqualTo("변경된 내용");
    }
}
